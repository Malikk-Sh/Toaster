...
const UPGRADE_TREE={
  fire:{ name:'ОГОНЬ', icon:'🔥', color:'#ff8a1e', nodes:[
    ...
    {id:'fire2', name:'Скорострел',           desc:'Заметно быстрее темп стрельбы',          cost:14},
    {id:'fire3', name:'Раздув жара',          desc:'ЖАР копится намного быстрее',            cost:26},
    {id:'fire4', name:'Поджигающий тост',     desc:'Тосты поджигают врагов — дольше и больнее',cost:40},
    {id:'fire5', name:'Двойной выстрел',      desc:'Выстрел бьёт двумя тостами',             cost:56},
    {id:'fireU', name:'Плавильный залп',      desc:'Тосты прожигают врага насквозь, взрыв крупнее',cost:80},
  ]},
  armor:{ name:'БРОНЯ', icon:'🛡', color:'#5aa6e0', nodes:[
    ...
    {id:'arm4', name:'Цепная детонация',      desc:'Враги взрываются и поджигают соседей',cost:40},
  ...
  speed:{ name:'РЫВОК', icon:'⚡', color:'#9fe06a', nodes:[
    ...
    {id:'spd3', name:'Тройной рывок',         desc:'Максимум зарядов рывка: 3',           cost:26},
    {id:'spd4', name:'Двойной прыжок',        desc:'Прыгай дважды в воздухе',             cost:40},
    {id:'spd5', name:'Рывок-таран',           desc:'Рывок бьёт сильнее и поджигает врагов',cost:56},
    {id:'spdU', name:'Фазовый рывок',         desc:'Дольше неуязвим во время рывка',      cost:80},
  ]},
};
function applyUpgrades(){
  const o=Save.data.owned;
  brad.maxhp = 100 + (o.arm1?30:0);
  brad.dmgMul = (o.fire1?1.25:1) * (o.fireU?1.15:1);
  brad.burnDmg = o.fire4?5:3;
  brad.burnMul = o.fire4?1.9:1;
  brad.tapCD = o.fire2?0.06:0.10;          // темп стрельбы
  brad.chargeRate = o.fire3?1.75:1.0;      // скорость накопления ЖАРА
  ...
  brad.dashRegen = o.spd2?0.55:0.9;
